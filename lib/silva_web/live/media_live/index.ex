defmodule SilvaWeb.MediaLive.Index do
  use SilvaWeb, :live_view

  alias Silva.Medias
  alias Silva.Medias.Media

  alias SilvaWeb.DynamicModalComponent
  ...
  @impl true
  def handle_info({SilvaWeb.MediaLive.FormComponent, {:saved, media}}, socket) do
